...
The system MUST define an `Options` struct holding all parsed flag values: `Model string`, `Tools string`, `ExcludeTools string`, `NoTools bool`, `NoExtensions bool`, `NoSkills bool`, `NoSession bool`, `Verbose bool`, `Mode string`, `Approve bool`, `Print bool`.
